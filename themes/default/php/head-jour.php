...
// Fond page
?>
body{ background: <?php echo $cfg_general['bg_jour']['Couleur']; ?> url("<?php echo $tpl; ?>/images/bg_jour.<?php echo $cfg_general['bg_jour']['Extension']; ?>") <?php echo $cfg_general['bg_jour']['Position']; ?> <?php echo $cfg_general['bg_jour']['Répétition']; ?> }
