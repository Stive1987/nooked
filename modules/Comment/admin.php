...
if ($visiteur >= $level_admin && $level_admin > -1){
	...
	function module_send_com($news, $download, $sections, $links, $gallery, $survey){
        global $nuked, $user;
    ...
    switch ($_REQUEST['op']){
		...
		case "module_send_com":
            module_send_com($_REQUEST['news'],$_REQUEST['download'],$_REQUEST['sections'],$_REQUEST['links'],$_REQUEST['gallery'],$_REQUEST['survey']);
            break;
