...
function reg_screen(){
    ...
    if ($nuked['inscription'] != "off"){
        if ($nuked['inscription_charte'] != "" && !isset($_REQUEST['charte_agree'])){
            ...
            echo "<table style=\"margin-left:auto;margin-right:auto;text-align:left;width:70%;\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">\n";


            echo '<tr><td colspan="2" align="center"><input type="submit" name="submit_captcha" value="' . _USERREGISTER . '" /></td></tr></table></form><br />';
        }
    }
    else{
